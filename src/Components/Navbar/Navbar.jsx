        ...
        <div className="navbar-wrap">
          <div className="navbar-left">
            <NavLink to="/" className="brand">
              <img src="/images/logo-single.svg" alt="brand" />{" "}
              <span>Astrac</span>
            </NavLink>
          ...
          <div className="navbar-right">
            ...
            <NavLink to="/contact">
              <button
                className="btn btn-secondary hide-mobo"
                onClick={() => setNavOpen(false)}
              >
                Contact
              </button>
            ...
            <button onClick={() => setNavOpen(!navOpen)} className="hmb">
              {navOpen ? <CgClose /> : <CgMenuLeft />}
            </button>
          </div>
        </div>
      </div>
