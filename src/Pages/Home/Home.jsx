...
const Home = () => {
    return (
        <main className='main'>
            <section className="image-top" data-aos="fade-up" data-aos-duration="2000">
     ...
     <CallVideo />
        ...
        <div className="container">
          <div className="customize-wrap center">
            ...
            <p className="subtitle">
              ...
              Vestibulum varius pharetra mi. <br />sUt tristique posuere massa
              eu lobortis. Maecenas maximus vel tellus.
            </p>
            <a href="#" className="btn-transparent justify-center mt-4"
              >Contact us <MdKeyboardArrowRight /></a>
          </div>
        </div>
        {/* <div className="decor">
      ...
      <section id="work">
        <div className="container">
          <img src={require('../../images/better-fit.svg').default} className="img-work" alt="work" data-aos="fade-up" />
          <Slider />
        </div>
      </section>
